...
export const AgregarLugarModal = ({ isOpen, onClose, onAgregar }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-slate-900 text-slate-100 rounded-2xl p-6 w-full max-w-md shadow-2xl border border-slate-800 space-y-4 animate-in fade-in zoom-in duration-200 my-auto">
